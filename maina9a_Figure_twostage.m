...
for  Gfunindex  = 1:5
    ...
    if Gfunindex == 1
        save('C:\Users\Kaitu\Desktop\Phd Papers\Paper 3-stochastic methods_phd3\phd3_SDCA\SDCA\Code_PhD3\Results\Figures\CappL1_Alla9a_SS.mat','TimSSDCSPG','TimSSPDCA', 'FunSSDCSPG','FunSSPDCA','TimVRSPA','TimSPDCA','FunVRSPA','FunSPDCA');
    elseif Gfunindex == 2
        save('C:\Users\Kaitu\Desktop\Phd Papers\Paper 3-stochastic methods_phd3\phd3_SDCA\SDCA\Code_PhD3\Results\Figures\L1L2_Alla9a_SS.mat','TimSSDCSPG','TimSSPDCA', 'FunSSDCSPG','FunSSPDCA','TimVRSPA','TimSPDCA','FunVRSPA','FunSPDCA');
    elseif Gfunindex == 3
        save('C:\Users\Kaitu\Desktop\Phd Papers\Paper 3-stochastic methods_phd3\phd3_SDCA\SDCA\Code_PhD3\Results\Figures\SCAD_Alla9a_SS.mat','TimSSDCSPG','TimSSPDCA', 'FunSSDCSPG','FunSSPDCA','TimVRSPA','TimSPDCA','FunVRSPA','FunSPDCA');
    elseif Gfunindex == 4
        save('C:\Users\Kaitu\Desktop\Phd Papers\Paper 3-stochastic methods_phd3\phd3_SDCA\SDCA\Code_PhD3\Results\Figures\MCP_Alla9a_SS.mat','TimSSDCSPG','TimSSPDCA', 'FunSSDCSPG','FunSSPDCA','TimVRSPA','TimSPDCA','FunVRSPA','FunSPDCA');
    else
        save('C:\Users\Kaitu\Desktop\Phd Papers\Paper 3-stochastic methods_phd3\phd3_SDCA\SDCA\Code_PhD3\Results\Figures\LSP_Alla9a_SS.mat','TimSSDCSPG','TimSSPDCA', 'FunSSDCSPG','FunSSPDCA','TimVRSPA','TimSPDCA','FunVRSPA','FunSPDCA');
    end
end