...
for  Gfunindex  = 1:5
    ...
    if Gfunindex == 1
        save('C:\Users\Kaitu\Desktop\phd3_SDCA\SDCA\Results\Figures\CappL1_Allrcv1.mat','TimVRSPA','TimSPDCA', 'FunVRSPA','FunSPDCA','GapVRSPA','GapSPDCA');
    elseif Gfunindex == 2
        save('C:\Users\Kaitu\Desktop\phd3_SDCA\SDCA\Results\Figures\L1L2_Allrcv1.mat','TimVRSPA','TimSPDCA', 'FunVRSPA','FunSPDCA','GapVRSPA','GapSPDCA');
    elseif Gfunindex == 3
        save('C:\Users\Kaitu\Desktop\phd3_SDCA\SDCA\Results\Figures\SCAD_Allrcv1.mat','TimVRSPA','TimSPDCA', 'FunVRSPA','FunSPDCA','GapVRSPA','GapSPDCA');
    elseif Gfunindex == 4
        save('C:\Users\Kaitu\Desktop\phd3_SDCA\SDCA\Results\Figures\MCP_Allrcv1.mat','TimVRSPA','TimSPDCA', 'FunVRSPA','FunSPDCA','GapVRSPA','GapSPDCA');
    else
        save('C:\Users\Kaitu\Desktop\phd3_SDCA\SDCA\Results\Figures\LSP_Allrcv1.mat','TimVRSPA','TimSPDCA', 'FunVRSPA','FunSPDCA','GapVRSPA','GapSPDCA');
    end
end